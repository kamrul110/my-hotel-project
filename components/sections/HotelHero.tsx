...
export default function HotelHero({ name }: HotelHeroProps) {
    ...
    <div className="bg-white">
      <div className="w-full mx-auto py-6 px-4">
        ...
        <div className="flex justify-between items-start mb-6">
          <div>
            <h1 className="text-3xl font-medium text-[#252525] mb-2">{name}</h1>
          ...
          <div className="flex items-center space-x-3">
            ...
            <Button className="bg-[#007DD0]  px-6 rounded-2xl">
              Reserve →
            </Button>
          </div>
        </div>
        ...
        {/* Content Section */}
        <div className=" grid-cols-1 lg:grid-cols-4 gap-8 mt-8 flex items-center justify-between w-[90%] ">
          {/* Left Content */}
          <div className="lg:col-span-3">
            ...
            <div className="flex items-center mb-6">
              ...
              <Button className="bg-[#007DD0] text-white px-4 py-2 rounded-full text-sm ml-4">
                <div>
                  <svg xmlns="http://www.w3.org/2000/svg" width="23" height="22" viewBox="0 0 23 22" fill="none">
                    <path d="M21.4598 9.97072C21.5134 10.8009 21.5134 11.6607 21.4598 12.4909C21.1856 16.7332 17.8536 20.1125 13.6706 20.3905C12.2435 20.4854 10.7536 20.4852 9.3294 20.3905C8.83896 20.3579 8.3044 20.2409 7.84401 20.0513C7.33177 19.8403 7.0756 19.7348 6.94544 19.7508C6.81527 19.7668 6.6264 19.9061 6.24868 20.1846C5.58268 20.6757 4.74367 21.0285 3.49943 20.9982C2.87026 20.9829 2.55568 20.9752 2.41484 20.7351C2.27401 20.495 2.44941 20.1626 2.80021 19.4978C3.28674 18.5758 3.59501 17.5203 3.12791 16.6746C2.32343 15.4666 1.6401 14.036 1.54024 12.4909C1.48659 11.6607 1.48659 10.8009 1.54024 9.97072C1.81441 5.72838 5.14639 2.34913 9.3294 2.07107C10.5318 1.99114 10.7812 1.97856 12 2.03368" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                    <path d="M21.5 4.5C21.5 6.433 19.933 8 18 8C16.067 8 14.5 6.433 14.5 4.5C14.5 2.567 16.067 1 18 1C19.933 1 21.5 2.567 21.5 4.5Z" stroke="white" stroke-width="1.5" />
                  </svg>
                </div>
                Message
              </Button>
          ...
          <div className="lg:col-span-1">
            <Card className="top-6  sticky">
              <CardContent className="p-6">
                ...
                <Button className="w-full bg-[#007DD0]  text-white py-3 rounded-lg">
                  Reserve
                </Button>
              </CardContent>
            </Card>
