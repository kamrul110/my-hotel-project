        ...
        <div className="flex items-center justify-between text-gray-600 text-xs sm:text-sm mb-3 xs:mb-4 sm:mb-5 space  ">
          ...
          <div className='flex space-x-2 '>
             ...
             <svg xmlns="http://www.w3.org/2000/svg" width="17" height="19" viewBox="0 0 17 19" fill="none">
              <path d="M2.7709 18.2545V6.29614C2.7709 3.88019 2.7709 2.67222 3.52144 1.92168C4.27197 1.17114 5.47995 1.17114 7.8959 1.17114H9.60423C12.0202 1.17114 13.2282 1.17114 13.9787 1.92168C14.7292 2.67222 14.7292 3.88019 14.7292 6.29614V18.2545H2.7709Z" stroke="#626262" strokeLinecap="round" strokeLinejoin="round" />
