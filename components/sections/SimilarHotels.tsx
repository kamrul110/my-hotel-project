...
const HotelCard: React.FC<{ hotel: HotelProps }> = ({ hotel }) => {
  return (
    <div className="flex-none w-full sm:w-80   overflow-hidden  transition-all duration-300">
      <div className="relative h-56 w-full">
        ...
        />
        <div className="absolute bottom-3 left-3 bg-black bg-opacity-60 px-3 py-1.5 rounded-full text-sm font-medium flex items-center text-white backdrop-blur-sm">
          <svg
            className="w-4 h-4 text-yellow-400 mr-1.5"
            fill="currentColor"
            viewBox="0 0 20 20"
          >
      ...
      <div className="mt-2 mb-6">
        <h3 className="text-lg font-semibold text-gray-900 mb-2 leading-tight">{hotel.title}</h3>
        <p className="text-sm text-gray-500 mb-4 line-clamp-3 leading-relaxed">{hotel.description}</p>
        ...
        <div className="flex items-center justify-between text-gray-600 text-sm mb-5">
          <span className="flex items-center">
            ...
            <span className="font-medium">{hotel.bedrooms}</span> Bedroom
          </span>
          <span className="flex items-center">
            <svg className="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 14v3m4-3v3m4-3v3M3 21h18M3 10h18M3 7l9-4 9 4M4 10v11M20 10v11" />
            </svg>
            <span className="font-medium">{hotel.bathrooms}</span> Bathroom
          </span>
          <span className="flex items-center">
            <svg className="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="flex items-center justify-between">
          <button className="bg-[#1E88E5] hover:bg-[#1976D2] text-white py-3 px-12 rounded-full font-semibold text-sm transition-colors duration-200 shadow-sm">
            Book Now
          </button>
          <button className="p-2.5 rounded-full bg-gray-50 hover:bg-gray-100 transition-colors duration-200 border border-gray-200">
            <svg
