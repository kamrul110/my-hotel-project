export default function Footer() {
  return (
    <footer className="bg-gray-900 text-white py-12 mt-16 ">
      <div className=" px-4  w-[86.26%] mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="#" className="text-gray-300 hover:text-white">Report Property</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white">Trust & Safety</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="#" className="text-gray-300 hover:text-white">Flights</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white">Car Rentals</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white">Airport Taxis</a></li>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © 2025 Joyinn. All rights reserved.
          </p>
